...
const data = [
  "/assets/images/tour/evening/1.jpg",
  "/assets/images/tour/evening/2.webp",
  "/assets/images/tour/evening/3.webp",
  "/assets/images/tour/evening/4.webp",
  "/assets/images/tour/evening/5.jpg",
  "/assets/images/tour/evening/6.jpg",
  "/assets/images/tour/evening/7.jpg",
  "/assets/images/tour/evening/8.jpg",
];
    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 items-center justify-between py-5">
        ...
        <div className="flex items-center gap-2">
          <div>
            <img
              src="/assets/images/tour/breakfast.png"
              alt=""
              className="w-[36px] h-[36px]"
            />
          </div>
          <div>
            <h5 className="text-[14px] font-bold">BreakFast</h5>
            <p className="text-[14px] font-normal text-[#123a3280]">
              Unlimited Food
            </p>
          </div>
