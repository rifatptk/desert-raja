        ...
        <Container>
            <div className='py-[70px]'>
                <div className='flex items-center justify-center mb-[50px]'>
                    <h2 className='text-[18px] font-[600]'>Frequently Asked Questions</h2>
                </div>
                    ...
                    {data?.map((item,i)=>{
                        return(
                            <div key={i} className="mb-[10px]">
                                <div className='flex items-start justify-between' onClick={()=>trogle(i)}>
                                    <h2 className='text-[18px] font-[600] cursor-pointer mb-[20px] mt-0'>{item.que}</h2>
                                    <button className='text-[22px] text-brand-red pt-0'>{select === i ? <IoIosArrowDown /> : <IoIosArrowUp />}</button>
                                </div>
                                <div className=''>
                                <p className={`text-[14px] font-normal text-[#123a3280] mb-[20px] duration-300 ${select === i ? "" : "hidden"} `}>{item.ans}</p>
                                </div>
